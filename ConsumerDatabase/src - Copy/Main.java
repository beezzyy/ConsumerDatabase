...
//This program is written on 09/18/21 by Adir Ben-David
...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {// This do-while loop is to make sure that this will repeat until the user
			// enters option 5
			do {// This do-while loop is to make sure the user inputs a number between 1-5. If
				// not it will repeat.
